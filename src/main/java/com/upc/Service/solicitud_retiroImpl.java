...
public class solicitud_retiroImpl implements solicitud_retiroService{
	...
	@Override
	public Iterable<solicitud_retiro> findsolicitudByEstado(String estado) {
		// TODO Auto-generated method stub
		return solicitudrepositorio.findsolicitudByEstado(estado);
	}

	@Override
	public Iterable<solicitud_retiro> findsolicitudByEstadoEnEspera() {
		// TODO Auto-generated method stub
		return solicitudrepositorio.findsolicitudByEstadoEnEspera();
	}
